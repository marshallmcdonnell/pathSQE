...
def define_data_set(T_Ei_conditions, **kwargs):
    ...
    for T, E in T_Ei_conditions:
        data_set={'Runs':list(range(180300, 180391+1)), # (15K,40meV):84040, 84159+1; (500K,40meV):79193, 79283+1; (750K,40meV):79092, 79192+1 
                  ...
                  'MaskingDataFile':shared_folder+'van180160.nxs',         #Options:None;data_file_name;
                  'NormalizationDataFile':shared_folder+'van180160.nxs',   #Options:None;data_file_name
                  'SampleLogVariables':{'OmegaMotorName':'CCR10G2Rot','Temperature':T},   #Options:None;LogVariableName;number
