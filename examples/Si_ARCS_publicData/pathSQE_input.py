    ...
    pathSQE_params = {
        ...
        "user defined Qpoints": {
            "path": [
                ...
                ("L", "W"),
                ("W", "X"),
            ],  # e.g. [('Gamma', 'X'), ('X', 'U'), ('K', 'Gamma'), ('Gamma', 'L'), ('L', 'W'), ('W', 'X')], total piece-wise path along which to process 2D inelastic slices, names must match strings in 'point_coords'
            "1d_points": [
                "K",
                "L",
        ...
        # saving and outputs
        "output directory": "../300K_80meV_bzFold/",  # where to save everything (will be created if doesn't exist)
