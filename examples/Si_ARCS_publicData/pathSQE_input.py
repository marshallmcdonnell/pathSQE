...
def define_pathSQE_params(**kwargs):
    ...
    'user defined Qpoints':{'path':[ ('Gamma', 'X'), ('X', 'U'), ('K', 'Gamma'), ('Gamma', 'L'), ('L', 'W'), ('W', 'X') ], # e.g. [('Gamma', 'X'), ('X', 'U'), ('K', 'Gamma'), ('Gamma', 'L'), ('L', 'W'), ('W', 'X')], total piece-wise path along which to process 2D inelastic slices, names must match strings in 'point_coords'
