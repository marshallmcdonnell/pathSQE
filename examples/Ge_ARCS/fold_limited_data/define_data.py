...
def define_data_set(T_Ei_conditions, **kwargs):
    ...
    for T, E in T_Ei_conditions:
        data_set={'Runs':69945, # going to sub this in using driver
              'BackgroundRuns':None,
              ...
              'SampleLogVariables':{'OmegaMotorName':'CCR16Rot','Temperature':T}, # hdfview on event.nxs, under entry->DASlogs
