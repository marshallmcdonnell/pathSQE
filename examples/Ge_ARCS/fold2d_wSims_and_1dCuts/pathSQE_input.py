    ...
    pathSQE_params = {
        ...
        "user defined Qpoints": {
            "path": [
                ("Gamma", "X"),
                ("X", "U"),
            ],  # , ('K', 'Gamma'), ('Gamma', 'L'), ('L', 'W'), ('W', 'X') ], # e.g. [ ('X', 'U'), ('K', 'Gamma') ], total piece-wise path along which to process 2D inelastic slices, names must match strings in 'point_coords'
            "1d_points": [
                "K",
                "L",
        ...
        # saving and outputs
        "output directory": "../Ge_5K_40meV_fold2d_wSims_and_1dCuts/",  # where to save everything (will be created if doesn't exist)
