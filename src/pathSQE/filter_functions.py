...
def evaluate_slice_quality(slice_name, filters, path_seg):
    ...
    if "contrast" in filters:
        ...
        non_nan_values = slice_data_withoutElasticLine[
            ~np.isnan(slice_data_withoutElasticLine)
        ]
        ...
        plt.savefig(
            os.path.join(
                "/SNS/ARCS/IPTS-5307/shared/Aiden/comprehensive/pathSQE_outputs/withFilters/",
                slice_name,
                ".png",
            )
        )
