...
def define_data_set(T_Ei_conditions, **kwargs):
    ...
    for T, E in T_Ei_conditions:
        data_set={'Runs':list(range(37769, 37859+1)), # 5K: list(range(43977, 44083+1));  300K: list(range(37769, 37859+1))
                    ...
                    'MaskingDataFile':shared_folder+'van37349_white_upstatic.nxs',         #Options:None;data_file_name
                    'NormalizationDataFile':shared_folder+'van37349_white_upstatic.nxs',   #Options:None;data_file_name
                    'SampleLogVariables':{'OmegaMotorName':'CCR12Rot','Temperature':T},   # 5K: 'CCR16Rot'; 300K: 'CCR12Rot'
                    ...
                    'UBSetup':{'ub':'0.12685824,-0.13193672,-0.01291855,0.06613873,0.07848529,-0.15209513,-0.11489062,-0.10049857,-0.10182034'},  # For Si 300K: 
